...
if __name__ == '__main__':
    ...
    print("\nIs letter T found inside the list?", fullname_tree.search("T"))
    print("Is letter E found inside the list?", fullname_tree.search("E"))
    fullname_tree.delete("I")
    print("\nLetter I was removed inside the list:", fullname_tree.in_order_traversal())
